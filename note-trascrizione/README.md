...
Più che altro per controllare cosa ha fatto l'LLM e perchè xP
Waring: output/trascrizioni/note iniziali generate automaticamente.

## Da dove partire

**[`NOTE-EDITORIALI.md`](NOTE-EDITORIALI.md)** — ogni singola scelta dell'LLM durante la
trascrizione, con il numero di pagina. Si apre con i punti rimasti irrisolti (~40), che
nel PDF sono già marcati con i riquadri *Dubbio* e *Lacuna*: è da lì che conviene cominciare.
...
- `trascrizioni/` — una per pagina del quaderno: LaTeX prodotto, note, specifiche delle figure
...
- revisione inziale della trascrizione fatta dallo stesso tipo di modello che ha scritto il testo, plausibilmente con gli stessi punti ciechi (poi rimane un LLM)
